...
if __name__ == '__main__':
    ...
    smartphone = Smartphone('Smartphone', weather_station)
    ...
    weather_station.state = {'Temperatuar': '30'}
    weather_station.state = {'Temperatuar': '32'}
    weather_station.state = {'Humidty': '90'}
